package com.lypeer.zhihudaily.data.news.bean;
...
public class LatestNewsResponse {
    ...
    public String getDate() {
        return BaseUtil.checkNotNull(date);
    }
    ...
    public List<StoriesBean> getStories() {
        return BaseUtil.checkNotNull(stories , new ArrayList<StoriesBean>());
    }
    ...
    public List<TopStoriesBean> getTop_stories() {
        return BaseUtil.checkNotNull(top_stories , new ArrayList<TopStoriesBean>());
    }
    ...
    public static class StoriesBean {
        ...
        public String getTitle() {
            return BaseUtil.checkNotNull(title);
        }
        ...
        public String getGa_prefix() {
            return BaseUtil.checkNotNull(ga_prefix);
        }
        ...
        public List<String> getImages() {
            return BaseUtil.checkNotNull(images , new ArrayList<String>());
        }
    ...
    public static class TopStoriesBean {
        ...
        public String getImage() {
            return BaseUtil.checkNotNull(image);
        }
